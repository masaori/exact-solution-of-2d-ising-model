...
# 第1項
num1_1 = (exp(2*K1) + 1) * (1 - ((exp(2*K1) - 1)/(exp(2*K1) + 1) * exp(-2*K2)) * exp(i*theta_mu))
den1_1 = (exp(2*K1) + 1) * (1 - ((exp(2*K1) - 1)/(exp(2*K1) + 1) * exp(-2*K2)) * exp(-i*theta_mu))

# 第2項
num1_2 = (exp(2*K1) + 1) * (exp(-2*K2) - ((exp(2*K1) - 1)/(exp(2*K1) + 1)) * exp(i*theta_mu))
den1_2 = (exp(2*K1) + 1) * (exp(-2*K2) - ((exp(2*K1) - 1)/(exp(2*K1) + 1)) * exp(-i*theta_mu))

# 式1全体（2項の積）
expr1 = (num1_1 / den1_1) * (num1_2 / den1_2)
...
# 第1項
num2_1 = (exp(2*K1) + 1) - (exp(2*K1) - 1) * exp(-2*K2) * exp(i*theta_mu)
den2_1 = (exp(2*K1) + 1) - (exp(2*K1) - 1) * exp(-2*K2) * exp(-i*theta_mu)

# 第2項
num2_2 = (exp(2*K1) + 1) * exp(-2*K2) - (exp(2*K1) - 1) * exp(i*theta_mu)
den2_2 = (exp(2*K1) + 1) * exp(-2*K2) - (exp(2*K1) - 1) * exp(-i*theta_mu)

# 式2全体（2項の積）
expr2 = (num2_1 / den2_1) * (num2_2 / den2_2)
