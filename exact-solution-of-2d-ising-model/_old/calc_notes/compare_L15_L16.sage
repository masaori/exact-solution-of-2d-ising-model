# ---------------------------------------------------------
# SageMath: 式1と式2の等価性検証コード (L.15 と L.16)
# ---------------------------------------------------------
...
num1 = (
    ...
    - (exp(2*K1) - 1)*(exp(2*K1) + 1)*exp(i*theta_mu)
    - exp(-2*K2)*exp(-2*K2)*(exp(2*K1) + 1)*(exp(2*K1) - 1)*exp(i*theta_mu)
    + exp(-2*K2)*(exp(2*K1) - 1)*(exp(2*K1) - 1)*exp(i*theta_mu)*exp(i*theta_mu)
)
