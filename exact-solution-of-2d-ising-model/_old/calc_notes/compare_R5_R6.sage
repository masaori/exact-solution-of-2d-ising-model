# ---------------------------------------------------------
# SageMath: 式1と式2の等価性検証コード (R.5 と R.6 の比較)
# ---------------------------------------------------------
...
# /
# (
#   (e^(2 K_1) + e^(-2 K_1)) e^(-2sqrt(-1) theta_(mu))
#   + (e^(2 K_1) + e^(-2 K_1))
#   - e^(-2sqrt(-1) theta_(mu))
#   + 1
#   - (e^(2 K_1) - e^(-2 K_1)) (e^(2 K_2) + e^(-2 K_2)) e^(-sqrt(-1) theta_(mu))
...
print("\n--- expr2 (R.6) simplified ---")
print(expr2_simplified)

# ---------------------------------------------------------
# 記号的な等価性チェック
# ---------------------------------------------------------
print("\n--- Symbolic check (comparing expressions without sqrt) ---")
